      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-10">
        ...
        <div className="bg-gray py-6 sm:py-8 lg:py-12">
          <div className="mx-auto max-w-screen-md px-4 md:px-8">
            <h2 className="mb-4 text-center text-2xl font-bold text-white md:mb-8 lg:text-3xl xl:mb-12">
              Customer Reviews
            </h2>
            <div className="mb-4 flex items-center justify-between border-t border-b py-4">
              ...
              <Link
                href={"/review"}
                className="inline-block rounded-lg border bg-white px-4 py-2 text-center text-sm font-semibold text-gray-800 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:px-8 md:py-3 md:text-base"
              >
                Write a review
              </Link>
            </div>
                  ...
                  return (
                    ...
                    <div className="flex flex-col gap-3 py-4 md:py-8">
                      <div>
                        ...
                        <span className="block text-sm text-gray-500">{rev.createdAt}</span>
                      </div>
                      {/* stars - start */}
                      <div className="-ml-1 flex gap-0.5">
                        <svg
